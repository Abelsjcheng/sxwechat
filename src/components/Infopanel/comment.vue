      ...
      <div style="margin-top:45px;">
        <group>
            ...
            <cell align-items="flex-start"  value-align="left">
                <img slot="title" src="../../assets/img/my.png" width="25" height="25" style="margin-right:1em;border-radius: 6px;margin-top: 0.5em;">
                <div>
                  <div class="comment-box-header">
                    <div>
                        <span class="comment-name" style="tex-align:left">王李沙 </span> <!--发表说说的用户昵称 -->
                        <p class="comment-time">2019-09-21 18:25:56</p>
                    </div>
                    <div>
                    <i class="fa fa-thumbs-o-up" style="font-size:15px;color: #999999;" @click="showemotion()" >1</i>
                    <i class="fa fa-comment-o" style="font-size:15px;color: #999999;margin-left:5px" @click="showemotion()" ></i>
                    </div>
                </div>
                <div class="comment-content">123456 </div> <!--说说的内容 -->
                <div class="recomment-content"><!--评论回复 -->
                    <div>
                        <span style="color: #094dcc">施景程:
                            <span style="color:#212121;">回复测试</span>
                        </span>
                        <!-- <span style="color: #094dcc" >共1条回复 </span> -->
...
<script>
import { XHeader, ViewBox, Popup, TransferDom, XTextarea, Cell, Group, WechatEmotion as Emotion, Swiper, SwiperItem, Toast  } from 'vux' // 导入组件
export default {
name: 'comment', // 全部评论
  directives: {
    TransferDom
  },
components: { XHeader, ViewBox, Popup, XTextarea, Cell, Group, Emotion, Swiper, SwiperItem, Toast }, // 注册组件
props: ['comment','commentslist'], // 定义父组件向子组件传递的对象
    data () {
        return {
            commentText: '',
            uname: '王李沙',
