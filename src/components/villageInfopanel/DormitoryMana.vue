...
<!-- 文化活动组件界面 -->
  <div>
      <div v-transfer-dom>
        <popup v-model="showDorMana" position="right" width="100%">
...
export default {
  ...
  methods: { // 方法函数
    ...
    backpage1 () { // 关闭详情弹窗
      ...
      this.axios.get('http://110.53.162.165:5050/api/beaCountry/ListBeaCountry?',{params:{vtype:4,pageIndex:1,pageSize:20 } }).then((res) => {
        this.list = [] // 置空初始化
